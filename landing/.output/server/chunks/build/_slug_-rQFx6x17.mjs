...
import { d as VIcon, V as VRow, a as VCol, c as VCard, e as VCardText, b as VBtn, D as VProgressCircular } from './VRow-DQkXkPiv.mjs';
  ...
  async setup(__props) {
    ...
    const breadcrumbs = computed(() => {
      ...
      return [
        ...
        { title: ((_a = transfer.value) == null ? void 0 : _a.name) || "", href: "" }
      ];
    });
    ...
    const breadcrumbSchema = computed(() => {
      ...
      return {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: ((_a = transfer.value) == null ? void 0 : _a.name) || "" }
        ]
      };
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(transfer)) {
        ...
        _push(`<script type="application/ld+json" data-v-fa9942c9>${(_a = JSON.stringify(unref(productSchema))) != null ? _a : ""}<\/script><script type="application/ld+json" data-v-fa9942c9>${(_b = JSON.stringify(unref(breadcrumbSchema))) != null ? _b : ""}<\/script><div class="page-hero" data-v-fa9942c9>`);
...
//# sourceMappingURL=_slug_-rQFx6x17.mjs.map
