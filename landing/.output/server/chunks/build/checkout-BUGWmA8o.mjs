import { u as useApi, H as Head, T as Title, V as VContainer } from './VContainer-CvzQlK5R.mjs';
import { defineComponent, ref, reactive, withCtx, unref, createTextVNode, toDisplayString, createVNode, isRef, withDirectives, vModelText, openBlock, createBlock, createCommentVNode, withModifiers, Fragment, renderList, createElementVNode, normalizeStyle, normalizeClass, computed, shallowRef, watchEffect, watch, mergeProps, nextTick, useSSRContext } from 'vue';
...
import { _ as _export_sfc, f as useI18n, g as useLocalePath, l as genericComponent, E as useProxiedModel, a1 as useDisplay, $ as filterInputAttrs, I as convertToUnit, p as propsFactory, W as callEvent, Z as omit, N as clamp } from './server.mjs';
import { u as useCartStore, f as forwardRefs } from './forwardRefs-BsiwRHAr.mjs';
import { d as VIcon, b as VBtn, V as VRow, a as VCol, c as VCard, f as VCardTitle, e as VCardText, u as useRender, I as Intersect, m as makeComponentProps } from './VRow-DQkXkPiv.mjs';
import { V as VChip } from './VChip-ChK3lbKv.mjs';
import { V as VTextField, c as createForm, u as useFocus, a as useAutocomplete, b as VInput, d as VField, e as VCounter, m as makeFormProps, f as useAutofocus, g as makeVFieldProps, h as makeVInputProps, i as makeAutocompleteProps } from './VTextField-w7s0k0rh.mjs';
  ...
  setup(__props) {
    ...
    async function submitOrder() {
      ...
      try {
        ...
        submitError.value = ((_a = err == null ? void 0 : err.data) == null ? void 0 : _a.message) || "Xato yuz berdi. Qayta urinib ko'ring.";
      } finally {
                                        ...
                                        (openBlock(true), createBlock(Fragment, null, renderList(unref(cartStore).items, (item) => {
                                          return openBlock(), createBlock("div", {
                                            ...
                                            createVNode("div", null, [
                                              ...
                                              createVNode("div", { class: "text-caption text-medium-emphasis" }, "\xD7 " + toDisplayString(item.quantity), 1)
                                            ]),
...
//# sourceMappingURL=checkout-BUGWmA8o.mjs.map
