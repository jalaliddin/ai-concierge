import { computed, ref, createVNode, mergeProps, createElementVNode, Fragment, withDirectives, normalizeClass, cloneVNode, toRef, useId, shallowRef, normalizeStyle, watch, vShow, nextTick, provide, markRaw, unref, inject } from 'vue';
import { V as VExpandXTransition, a as VSlideYTransition } from './index-wObflqc9.mjs';
import { I as Intersect, u as useRender, j as useDensity, k as useDimension, G as useLoader, p as useRounded, F as useBackgroundColor, q as useTextColor, H as Box, L as LoaderSlot, s as VDefaultsProvider, M as MaybeTransition, B as makeDimensionProps, C as makeDensityProps, m as makeComponentProps, x as makeRoundedProps, J as makeLoaderProps, K as makeTransitionProps, d as VIcon } from './VRow-DQkXkPiv.mjs';
import { l as genericComponent, E as useProxiedModel, $ as filterInputAttrs, Z as omit, v as getCurrentInstanceName, C as provideTheme, m as useRtl, X as standardEasing, W as callEvent, p as propsFactory, H as consoleWarn, U as useLocale, F as wrapInArray, s as getCurrentInstance, O as useToggleScope, L as IconValue, B as makeThemeProps, Y as pick, V as EventProp, I as convertToUnit } from './server.mjs';
import { f as forwardRefs, n as nullifyTransforms, a as animate } from './forwardRefs-BsiwRHAr.mjs';
...
export { VTextField as V, useAutocomplete as a, VInput as b, createForm as c, VField as d, VCounter as e, useAutofocus as f, makeVFieldProps as g, makeVInputProps as h, makeAutocompleteProps as i, makeFormProps as m, useFocus as u };
//# sourceMappingURL=VTextField-w7s0k0rh.mjs.map
