  ...
  async setup(__props) {
    ...
    const breadcrumbs = computed(() => {
      ...
      return [
        ...
        { title: ((_a = post.value) == null ? void 0 : _a.title) || "", href: "" }
      ];
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(post)) {
        ...
        _push(`<script type="application/ld+json" data-v-c179ebbd>${(_a = JSON.stringify(unref(articleSchema))) != null ? _a : ""}<\/script><div class="page-hero" data-v-c179ebbd>`);
...
//# sourceMappingURL=_slug_-DpOg6x85.mjs.map
