...
import { inject as inject$1, toRef, provide, ref, computed, unref, toRaw, warn as warn$1, toValue, Fragment, watch, onScopeDispose, capitalize as capitalize$1, hasInjectionContext, getCurrentScope, defineComponent as defineComponent$1, getCurrentInstance as getCurrentInstance$2, shallowRef, reactive, watchEffect, createVNode, mergeProps, createElementVNode, effectScope, h, normalizeClass, createElementBlock, cloneVNode, defineAsyncComponent, shallowReactive, Suspense, createApp, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRefs } from 'vue';
import { r as parseURL, f as encodePath, s as decodePath, l as createError$1, t as hasProtocol, v as isScriptProtocol, o as joinURL, w as withQuery, x as sanitizeStatusCode, y as getContext, z as parsePath, A as parseQuery, $ as $fetch$1, B as baseURL, C as defu, D as createHooks, E as executeAsync, F as getRequestURL, G as getRequestHeader, H as getCookie, I as klona, J as destr, K as isEqual$1, L as createDefu, M as setCookie, N as deleteCookie, O as withoutTrailingSlash, P as isEqual$2 } from '../nitro/nitro.mjs';
import { setActivePinia, createPinia, shouldHydrate } from 'pinia';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'vue/server-renderer';
import { u as useHead$1, h as headSymbol, a as useServerHead$1 } from '../routes/renderer.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
function tryUseNuxtApp(id) {
  ...
  if (hasInjectionContext()) {
    nuxtAppInstance = getCurrentInstance$2()?.appContext.app.$nuxt;
  }
...
const matcher = /* @__PURE__ */ (() => {
  const $0 = {}, $1 = { redirect: "/sitemap_index.xml" }, $2 = { payload: true, payload: true };
  return (m, p) => {
    let r = [];
    ...
    if (p === "/sitemap.xsl") {
      ...
      r.unshift({ data: $2 });
    } else if (p === "/en-sitemap.xml") {
      r.unshift({ data: $2 });
    } else if (p === "/ru-sitemap.xml") {
      r.unshift({ data: $2 });
    } else if (p === "/uz-sitemap.xml") {
      r.unshift({ data: $2 });
    }
    return r;
  };
...
function inferDecimalSeparator$1(n) {
...
function createAdapter(vuetifyOptions) {
  ...
  vuetifyOptions.locale.adapter = {
    ...
    decimalSeparator: toRef(() => inferDecimalSeparator$1(i18n.n))
  };
}
function createProvideFunction$1(data) {
  return (props) => {
    ...
    return {
      ...
      t,
      n,
      decimalSeparator: toRef(() => props.decimalSeparator ?? inferDecimalSeparator$1(n)),
...
const component_45stubJBcUFxya6vRzbkzXGAiTOu0tmWVK452iy7znU2fs5tc = {};
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BiN3Jbts.mjs')
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    name: "checkout___en",
    path: "/en/checkout",
    component: () => import('./checkout-BUGWmA8o.mjs')
  },
  {
    name: "checkout___ru",
    path: "/ru/checkout",
  ...
  },
  {
    name: "blog___en",
    path: "/en/blog",
    component: () => import('./index-BPaXNxsL.mjs')
  },
  {
    name: "blog___ru",
    path: "/ru/blog",
  ...
  },
  {
    name: "blog-slug___en",
    path: "/en/blog/:slug()",
    component: () => import('./_slug_-DpOg6x85.mjs')
  },
  {
    name: "blog-slug___ru",
    path: "/ru/blog/:slug()",
  ...
  },
  {
    name: "services___en",
    path: "/en/services",
    component: () => import('./index-DfyuHNTI.mjs')
  },
  {
    name: "services___ru",
    path: "/ru/services",
  ...
  },
  {
    ...
    component: () => import('./_slug_-CIF-JKBu.mjs')
  },
  {
  ...
  {
    name: "services-slug___uz",
    path: "/uz/services/:slug()",
    component: () => import('./_slug_-CIF-JKBu.mjs')
  },
  {
    name: "transfers___en",
    path: "/en/transfers",
    component: () => import('./index-ydWsMqGK.mjs')
  },
  {
    name: "transfers___ru",
    path: "/ru/transfers",
  ...
  {
    name: "transfers-slug___en",
    path: "/en/transfers/:slug()",
    component: () => import('./_slug_-rQFx6x17.mjs')
  },
  {
    name: "transfers-slug___ru",
    path: "/ru/transfers/:slug()",
    component: () => import('./_slug_-rQFx6x17.mjs')
  },
  {
    name: "transfers-slug___uz",
    path: "/uz/transfers/:slug()",
    component: () => import('./_slug_-rQFx6x17.mjs')
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/en/sitemap.xml",
    component: component_45stubJBcUFxya6vRzbkzXGAiTOu0tmWVK452iy7znU2fs5tc
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/ru/sitemap.xml",
  ...
  en: [
    {
      ...
      load: () => import(
        './en-kOnR8gm7.mjs'
        /* webpackChunkName: "locale_en_46json_861b5763" */
      ),
      cache: true
    }
  ],
  ru: [
    {
      ...
      load: () => import(
        './ru-D8h5Eoeq.mjs'
        /* webpackChunkName: "locale_ru_46json_bbd3bcfc" */
      ),
      cache: true
    }
  ],
  uz: [
    {
      ...
      load: () => import(
        './uz-C1amYDc1.mjs'
        /* webpackChunkName: "locale_uz_46json_f7fc3236" */
      ),
      cache: true
    }
  ]
...
var define_I18N_LOCALE_HASHES_default$1 = { en: "95680e6e", ru: "95680e6e", uz: "95680e6e" };
...
var define_I18N_LOCALE_HASHES_default = { en: "95680e6e", ru: "95680e6e", uz: "95680e6e" };
...
function vuetifyConfiguration() {
  const options = { "theme": { "defaultTheme": "khiva", "themes": { "khiva": { "dark": false, "colors": { "primary": "#0D1B2A", "secondary": "#1B263B", "accent": "#14B8A6", "cta": "#F59E0B", "background": "#F8FAFC", "surface": "#FFFFFF", "error": "#DC2626", "success": "#16A34A" } } } }, "ssr": true };
  return options;
}
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DmALOg5q.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BIoHq9pN.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-JOK4bhBM.mjs'));
...
export { filterInputAttrs as $, getForeground as A, makeThemeProps as B, provideTheme as C, provideDefaults as D, useProxiedModel as E, wrapInArray as F, findChildrenWithProvide as G, consoleWarn as H, convertToUnit as I, useTheme as J, useIcon as K, IconValue as L, flattenFragments as M, clamp as N, useToggleScope as O, PREFERS_REDUCED_MOTION as P, hasEvent as Q, isObject as R, onlyDefinedProps as S, breakpoints as T, useLocale as U, EventProp as V, callEvent as W, standardEasing as X, pick as Y, omit as Z, _export_sfc as _, useRouter as a, makeDisplayProps as a0, useDisplay as a1, useGoTo as a2, focusableChildren as a3, useRoute as a4, refElement as a5, CircularBuffer as a6, consoleError as a7, defer as a8, matchesSelector as a9, acceleratedEasing as aa, deceleratedEasing as ab, pickWithRest as ac, defineComponent as ad, deprecate as ae, focusChild as af, getPropertyFromItem as ag, isClickInsideElement as ah, getNextElement as ai, useSwitchLocalePath as aj, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, useI18n as f, useLocalePath as g, asyncDataDefaults as h, createError as i, fetchDefaults as j, useRequestFetch as k, genericComponent as l, useRtl as m, navigateTo as n, includes as o, propsFactory as p, isPrimitive as q, resolveRouteObject as r, getCurrentInstance as s, templateRef as t, useHead as u, getCurrentInstanceName as v, destructComputed as w, isCssColor as x, isParsableColor as y, parseColor as z };
