...
import { d as VIcon, V as VRow, a as VCol, c as VCard, e as VCardText, b as VBtn } from './VRow-DQkXkPiv.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<script type="application/ld+json" data-v-6869e07b>${(_a = JSON.stringify(breadcrumbSchema)) != null ? _a : ""}<\/script><div class="page-hero" data-v-6869e07b>`);
...
//# sourceMappingURL=index-ydWsMqGK.mjs.map
