import { shallowRef, computed, toRef, watch, h, capitalize, camelize, isRef, useId, provide, inject, resolveDynamicComponent, reactive, toValue, nextTick, ref, readonly, createVNode, normalizeStyle, normalizeClass, mergeProps, toRefs, Text, watchEffect, createElementVNode, Transition, withDirectives, toDisplayString, Fragment, vShow, unref, TransitionGroup } from 'vue';
import { l as genericComponent, J as useTheme, K as useIcon, C as provideTheme, s as getCurrentInstance, v as getCurrentInstanceName, w as destructComputed, o as includes, I as convertToUnit, p as propsFactory, L as IconValue, B as makeThemeProps, m as useRtl, Q as hasEvent, t as templateRef, T as breakpoints, x as isCssColor, y as isParsableColor, z as parseColor, A as getForeground, q as isPrimitive, R as isObject, D as provideDefaults, M as flattenFragments, N as clamp, P as PREFERS_REDUCED_MOTION, E as useProxiedModel, O as useToggleScope, F as wrapInArray, G as findChildrenWithProvide, S as onlyDefinedProps, H as consoleWarn } from './server.mjs';
...
export { deepEqual as $, makeElevationProps as A, makeDimensionProps as B, makeDensityProps as C, VProgressCircular as D, VImg as E, useBackgroundColor as F, useLoader as G, Box as H, Intersect as I, makeLoaderProps as J, makeTransitionProps as K, LoaderSlot as L, MaybeTransition as M, useBorder as N, useSize as O, useGroupItem as P, useLink as Q, Ripple as R, VAvatar as S, makeSizeProps as T, makeRouterProps as U, VRow as V, makeGroupItemProps as W, makeBorderProps as X, makeGroupProps as Y, useGroup as Z, useResizeObserver as _, VCol as a, VProgressLinear as a0, useRouter as a1, toPhysical as a2, getTargetBox as a3, parseAnchor as a4, flipSide as a5, flipAlign as a6, flipCorner as a7, getElementBox as a8, getAxis as a9, getOverflow as aa, VBtn as b, VCard as c, VIcon as d, VCardText as e, VCardTitle as f, VCardSubtitle as g, VCardActions as h, useVariant as i, useDensity as j, useDimension as k, useElevation as l, makeComponentProps as m, useLocation as n, usePosition as o, useRounded as p, useTextColor as q, genOverlays as r, VDefaultsProvider as s, createSimpleFunctional as t, useRender as u, makeVariantProps as v, makeTagProps as w, makeRoundedProps as x, makePositionProps as y, makeLocationProps as z };
//# sourceMappingURL=VRow-DQkXkPiv.mjs.map
