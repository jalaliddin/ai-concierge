...
import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$2, inject as inject$1, toRef, onScopeDispose, computed, shallowRef, isRef, defineComponent as defineComponent$1, h, Fragment, createVNode, Text, ref, watch, warn as warn$1, watchEffect, capitalize as capitalize$1, unref, provide, toValue, mergeProps, createElementVNode, normalizeClass, isReadonly, createElementBlock, cloneVNode, isShallow, isReactive, toRaw, toRefs, defineAsyncComponent, Suspense, nextTick, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/h3/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu, createDefu } from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/defu/dist/defu.mjs";
import { setupDevtoolsPlugin } from "@vue/devtools-api";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, parsePath, parseQuery, withoutTrailingSlash, isEqual as isEqual$2 } from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/ufo/dist/index.mjs";
import { klona } from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/klona/dist/index.mjs";
import { useServerHead as useServerHead$1, headSymbol, useHead as useHead$1 } from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/@unhead/vue/dist/index.mjs";
import "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/consola/dist/index.mjs";
import { parse as parse$1 } from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/destr/dist/index.mjs";
import { isEqual as isEqual$1 } from "/home/eversoft/Projects/khivatourguide.com/app/landing/node_modules/ohash/dist/index.mjs";
...
function createCompileError(code, loc, options = {}) {
  ...
  const msg = process.env.NODE_ENV !== "production" ? format$2((messages || errorMessages$2)[code] || "", ...args || []) : code;
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BiN3Jbts.js")
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    name: "checkout___en",
    path: "/en/checkout",
    component: () => import("./_nuxt/checkout-BUGWmA8o.js")
  },
  {
    name: "checkout___ru",
    path: "/ru/checkout",
  ...
  },
  {
    name: "blog___en",
    path: "/en/blog",
    component: () => import("./_nuxt/index-BPaXNxsL.js")
  },
  {
    name: "blog___ru",
    path: "/ru/blog",
  ...
  },
  {
    name: "blog-slug___en",
    path: "/en/blog/:slug()",
    component: () => import("./_nuxt/_slug_-DpOg6x85.js")
  },
  {
    name: "blog-slug___ru",
    path: "/ru/blog/:slug()",
  ...
  },
  {
    name: "services___en",
    path: "/en/services",
    component: () => import("./_nuxt/index-DfyuHNTI.js")
  },
  {
    name: "services___ru",
    path: "/ru/services",
  ...
  },
  {
    ...
    component: () => import("./_nuxt/_slug_-CIF-JKBu.js")
  },
  {
  ...
  },
  {
    name: "transfers___en",
    path: "/en/transfers",
    component: () => import("./_nuxt/index-ydWsMqGK.js")
  },
  {
    name: "transfers___ru",
    path: "/ru/transfers",
  ...
  },
  {
    ...
    component: () => import("./_nuxt/_slug_-rQFx6x17.js")
  },
  {
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-DmALOg5q.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BIoHq9pN.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-JOK4bhBM.js"));
...
export {
  ...
  makeThemeProps as B,
  provideTheme as C,
  provideDefaults as D,
  useProxiedModel as E,
  wrapInArray as F,
  findChildrenWithProvide as G,
  consoleWarn as H,
  convertToUnit as I,
  useTheme as J,
  useIcon as K,
  ...
  _export_sfc as _,
  useRouter as a,
  makeDisplayProps as a0,
  useDisplay as a1,
  useGoTo as a2,
  focusableChildren as a3,
  useRoute as a4,
  refElement as a5,
  CircularBuffer as a6,
  consoleError as a7,
  defer as a8,
  matchesSelector as a9,
  acceleratedEasing as aa,
  deceleratedEasing as ab,
  pickWithRest as ac,
  defineComponent as ad,
  deprecate as ae,
  focusChild as af,
  getPropertyFromItem as ag,
  isClickInsideElement as ah,
  getNextElement as ai,
  useSwitchLocalePath as aj,
  useNuxtApp as b,
  ...
  templateRef as t,
  useHead as u,
  getCurrentInstanceName as v,
  destructComputed as w,
  isCssColor as x,
  isParsableColor as y,
  parseColor as z
};
