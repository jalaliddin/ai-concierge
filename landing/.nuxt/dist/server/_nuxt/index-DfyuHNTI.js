...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const services = computed(() => data.value?.data || data.value || []);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<script type="application/ld+json" data-v-0666a05b>${JSON.stringify(breadcrumbSchema) ?? ""}<\/script><div class="page-hero" data-v-0666a05b>`);
...
//# sourceMappingURL=index-DfyuHNTI.js.map
