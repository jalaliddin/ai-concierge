import { u as useApi, H as Head, T as Title, M as Meta, L as Link, V as VContainer } from "./VContainer-CvzQlK5R.js";
import { defineComponent, inject, mergeProps, withCtx, createTextVNode, unref, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext, withAsyncContext, computed, ref, Fragment, renderList, isRef, withKeys } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderAttrs, ssrRenderList } from "vue/server-renderer";
import { u as useCartStore } from "./forwardRefs-BsiwRHAr.js";
import { f as useI18n, _ as _export_sfc, g as useLocalePath, c as useRuntimeConfig } from "../server.mjs";
import { V as VCard, a as VIcon, b as VCardText, c as VBtn, d as VRow, e as VCol, f as VCardTitle, g as VCardSubtitle, h as VCardActions } from "./VRow-DQkXkPiv.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<script type="application/ld+json" data-v-d7406e46>${JSON.stringify(travelAgencySchema) ?? ""}<\/script><section class="hero-section" data-v-d7406e46>`);
            ...
            if (unref(pending)) {
              ...
              _push2(ssrRenderComponent(VRow, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<!--[-->`);
                    ssrRenderList(unref(transfers)?.slice(0, 4), (transfer) => {
                      _push3(ssrRenderComponent(VCol, {
                        key: transfer.id,
                        cols: "12",
                        sm: "6",
                    ...
                    return [
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(transfers)?.slice(0, 4), (transfer) => {
            ...
            if (unref(pending)) {
              ...
              _push2(ssrRenderComponent(VRow, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<!--[-->`);
                    ssrRenderList(unref(catalog)?.services?.slice(0, 3), (service) => {
                      _push3(ssrRenderComponent(VCol, {
                        key: service.id,
                        cols: "12",
                        sm: "6",
                    ...
                    return [
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(catalog)?.services?.slice(0, 3), (service) => {
                        return openBlock(), createBlock(VCol, {
                          key: service.id,
                          cols: "12",
                          sm: "6",
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  ...
                                  _push5(ssrRenderComponent(VCardText, { class: "text-medium-emphasis text-body-2" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`${ssrInterpolate(post.excerpt?.substring(0, 120))}... `);
                                      } else {
                                        return [
                                          createTextVNode(toDisplayString(post.excerpt?.substring(0, 120)) + "... ", 1)
                                        ];
                                      }
                                    }),
                                    _: 2
...
//# sourceMappingURL=index-BiN3Jbts.js.map
