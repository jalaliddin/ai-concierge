...
import { a as VIcon, d as VRow, e as VCol, V as VCard, b as VCardText, a9 as VImg, c as VBtn, _ as VProgressCircular } from "./VRow-DQkXkPiv.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const service = computed(() => data.value?.data || data.value);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(service)) {
        ...
        _push(`<script type="application/ld+json" data-v-71869f50>${JSON.stringify(unref(touristTripSchema)) ?? ""}<\/script><script type="application/ld+json" data-v-71869f50>${JSON.stringify(unref(breadcrumbSchema)) ?? ""}<\/script><div class="page-hero" data-v-71869f50>`);
...
//# sourceMappingURL=_slug_-CIF-JKBu.js.map
